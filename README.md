# nvim-treesitter-queries-kitty

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-kitty/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-kitty/actions/workflows/validate.yml)

Neovim tree-sitter queries for **kitty**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-kitty",
...
- [ ] Changes are scoped to `kitty` — do not include files for other languages
